...
The first workflow is dedicated to CI and is automatically triggered on each push or pull request to the main development branch. 
...
The second workflow implements CD and is responsible for building, releasing, and publishing the software. This workflow is automatically triggered when a version tag (e.g. v1.0.0) is pushed to the repository. 
